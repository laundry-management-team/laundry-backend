...
export interface OrderNumberCounterDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `id`
   * const orderNumberCounterWithIdOnly = await prisma.orderNumberCounter.findMany({ select: { id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OrderNumberCounters and only return the `id`
   * const orderNumberCounterWithIdOnly = await prisma.orderNumberCounter.createManyAndReturn({
   *   select: { id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more OrderNumberCounters and only return the `id`
   * const orderNumberCounterWithIdOnly = await prisma.orderNumberCounter.updateManyAndReturn({
   *   select: { id: true },
   *   where: {
   *     // ... provide filter here
   *   },
